...
public class StudyGroupControllerTests
{
    ...
    {
        var group = new StudyGroup(1, "Math Masters", Subject.Math, DateTime.Now, new List<User>());
    ...
    public async Task GetStudyGroups_Returns_List()
    {
        ...
        {
            new StudyGroup(1, "Physics Stars", Subject.Physics, DateTime.Now, new List<User>())
        };
    ...
    public async Task SearchStudyGroups_Returns_Filtered()
    {
        var mockGroups = new List<StudyGroup>
        {
            new StudyGroup(2, "Math Club", Subject.Math, DateTime.Now, new List<User>())
        };
